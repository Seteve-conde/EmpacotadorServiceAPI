...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "EmpacotadorServiceAPI", Version = "v1" });
...
var key = builder.Configuration["Jwt:Key"] ?? throw new ArgumentNullException("Jwt:Key não encontrado nas configurações");
